...
import com.li.product.dao.ProductDao;
import com.li.product.domain.Order;
import com.li.product.domain.PageBean;
import com.li.product.domain.Product;
...
public class ProductService {
	...
	public PageBean findBooksPage(int currentPage, int pageSize,String category) {
		...
		try {
			int count  = productDao.count(category);//得到总记录数,要加上category
