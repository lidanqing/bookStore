...
public class SendJMail {
		...
		String from = "ldq2012hfut@163.com"; 				// 邮件发送人的邮件地址
		String to = email; 										// 邮件接收人的邮件地址
		final String username = "ldq2012hfut@163.com";  	//发件人的邮件帐户
		final String password = "dream215";   					//发件人的邮件密码
		...
		props.setProperty("mail.smtp.auth", "true");//是否验证用户登录信息
